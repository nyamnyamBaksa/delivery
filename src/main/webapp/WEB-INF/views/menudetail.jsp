...
<i class="fa-solid fa-hammer fa-rotate-270 fa-lg" style="color: #eb5757;"></i>이미지 준비중<i class="fa-solid fa-wrench fa-lg" style="color: #eb5757;"></i></c:if>
<c:if test="${mf.mnimg != null}">${mf.mnimg}</c:if>
		...
		<br>
		<input id="sidecheckbox"  type='checkbox' name='sidemenu' value='${mf.mnno}' > <span id="sidemenu"> ${sideMenuList}</span> <span class="price"> + ${mf.mnprice }원</span>
